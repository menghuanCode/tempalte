...
export async function query(params: IListParams): Promise<IResponse> {
  return request('/api/bkCandyQuotaAccountRecord/page', {
    method: 'POST',
    requestType: 'json',
    data: params
  });
...
export async function deleteById(params: { id: string }): Promise<IResponse> {
  return request('/api/bkCandyQuotaAccountRecord/delete', {
    method: 'GET',
    requestType: 'form',
    params: params
  });
...
export async function deleteBatchIds(params: { ids: string }): Promise<IResponse> {
  return request('/api/bkCandyQuotaAccountRecord/deleteBatchIds', {
    method: 'POST',
    requestType: 'form',
    data: params
  });
...
export async function save(params: Store): Promise<IResponse> {
  return request('/api/bkCandyQuotaAccountRecord/save', {
    method: 'POST',
    requestType: 'json',
    data: params
  });
